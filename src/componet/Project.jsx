...
const Project = () => {
  ...
  return (
    ...
    className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32  my20 w-full overflow-hidden' id='Project'>
      <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center'>
        Projects <span className='underline underline-offset-4 decoration-1 under font-light'>Completed</span>
        <p className='text-center text-gray-500 mb-8 max-w-[550px] mx-auto'>Crafting Spaces, Building Legacies-Explore Our Porfolio</p>
