    ...
    <div className='pt-10 md:px-20 px-4 lg:px-32 bg-gray-900 w-full overflow-hidden' id='Footer'>
      <div className='container mx-auto flex flex-col md:flex-row justify-between items-start '>
        <div className='w-full md:w-1/3 mb-8 md:mb-0'>
            ...
            <p className='text-gray-400 mt-5'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde iure dolores omnis, asperiores tenetur cupiditate, cum reiciendis, ut ipsam dolorum accusamus</p>
        </div>
        ...
        <div className='w-full md:w-1/3'>
            ...
            <p className='text-gray-400 mb-4 max-w-80'> The lastest news, articles and resources, send to your inbox weekly</p>
      ...
      <div className='border-t border-gray-700 py-4 mt-10 text-center text-gray-500'>
        Copayright 2025 KeoChanmaridoDev. All Right Reserved.
      </div>
    </div>
  )
}
